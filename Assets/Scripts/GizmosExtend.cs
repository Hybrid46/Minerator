...
namespace GizmoExtension
{
	...
	public static class GizmosExtend
	{
		...
		#region Cube
		public static void DebugDrawBox(Vector3 origin, Vector3 halfExtents, Quaternion orientation, Color color = default(Color))
		{
			DrawBox(new Box(origin, halfExtents, orientation), color);
		}

		public static void DebugDrawBox(Box box, Color color = default(Color))
		{
			using (new ColorScope(color))
			{
